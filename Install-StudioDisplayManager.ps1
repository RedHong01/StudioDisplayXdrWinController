...
$hdrScreenshotGuardSource = Join-Path $sourceRoot "HdrScreenshotGuard.ps1"
$hdrScreenshotGuardTarget = Join-Path $installRoot "HdrScreenshotGuard.ps1"
...
$offlineMaintenanceGuardSource = Join-Path $sourceRoot "Test-StudioDisplayOfflineMaintenanceGuards.ps1"
$offlineMaintenanceGuardTarget = Join-Path $installRoot "Test-StudioDisplayOfflineMaintenanceGuards.ps1"
...
foreach ($pidPath in @($managerPidFile, $mirrorPidFile, $bridgePidFile, $hdrScreenshotGuardPidFile, $legacyTrayPidFile, $legacyManagerPidFile, $legacyMirrorPidFile, $legacyBridgePidFile)) {
...
Copy-Item -LiteralPath $hdrScreenshotGuardSource -Destination $hdrScreenshotGuardTarget -Force
...
Copy-Item -LiteralPath $offlineMaintenanceGuardSource -Destination $offlineMaintenanceGuardTarget -Force
